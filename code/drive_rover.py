...
class RoverState():
    def __init__(self):
        ...
        self.stuck_counter = 0 # counter for detecting stuck mode and exiting stuck mode
        self.go_to_rock_counter = 0 # counter for going to rock and getting unstuck in this mode
        self.start_pos = None # holds the start position of the rover
        self.loop_counter = 0 # counter for detecting loop beahviour and exiting loop mode
